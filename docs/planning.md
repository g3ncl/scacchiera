...
- [ ] V1 component and library proof: fitted-board sourcing is complete, but the external display
  ...
  [verification/v1-components.yaml](verification/v1-components.yaml) exactly matches 49 unique
  ...
  and module straps are not yet bound. The load budget conservatively uses 320 mA each. Every other
...
conflict and interconnect, while the power board needs a stronger boost converter before V3. V2
