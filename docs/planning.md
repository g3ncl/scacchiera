...
- [x] V1 component and library proof: [verification/v1-components.yaml](verification/v1-components.yaml)
  exactly matches the 44 unique purchased fitted MPN, supplier, order-code, and footprint tuples
  generated by the three authoritative schematics. It separately audits the purchased PiSugar 3
