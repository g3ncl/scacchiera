...
- [ ] V1 component and library proof: fitted-board sourcing is complete, but the external display
  ...
  [verification/v1-components.yaml](verification/v1-components.yaml) exactly matches 57 unique
...
- [ ] V3 power-board addition: `hardware/tests/test_sim_power_boost.py` sweeps 54 switching-stage
  ...
  protection timing, temperature and ESR corners remain open. The CSD25404Q3 and TLV7021 reverse
