...
# BQ25895RTWR datasheet

This source binds [BQ25895RTWR](../entities/bq25895rtwr.md) to supplier order
code `C80200`. It is used by power U1 (BQ25895RTWR).

[mpn::BQ25895RTWR] [order_code::C80200]
...
- Exact selected limits: 3.9 to 14 V input operating range, 5 A charge-current capability, NVDC power path, 6 A continuous and 9 A one-second battery discharge path, 19 mOhm maximum BATFET resistance over temperature, 9 A overcurrent threshold and RTW WQFN-24 pinout.
